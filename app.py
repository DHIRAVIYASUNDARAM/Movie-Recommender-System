...
# --- Configuration ---
# IMPORTANT: This path MUST point to the directory that directly contains
...
def load_and_process_data(data_path):
    ...
    try:
        ...
        # The error message will now specifically mention .csv files if they are missing
        st.error(f"Error: Data files (ratings.csv or movies.csv) not found at {data_path}.")
